...
//        button.backgroundColor = (colorScheme == .dark ? Color.white : Color.black)
//
//        // Set text color
...
//        imageView.backgroundColor = (colorScheme == .dark ? Color.white : Color.black)
...
//                    NSAttributedString.Key.foregroundColor: (colorScheme == .dark ? Color.black : Color.white),
