...
class CameraViewController: UIViewController, AVCaptureVideoDataOutputSampleBufferDelegate, AVCapturePhotoCaptureDelegate {
    ...
    func setupButton(_ button: UIButton, title: String) {
            ...
            // Use `traitCollection` to check the current color scheme
            let userInterfaceStyle = traitCollection.userInterfaceStyle
            button.backgroundColor = userInterfaceStyle == .dark ? UIColor.white : UIColor.black
            button.setTitleColor(userInterfaceStyle == .dark ? .black : .white, for: .normal)
    ...
    override func traitCollectionDidChange(_ previousTraitCollection: UITraitCollection?) {
            ...
            if traitCollection.hasDifferentColorAppearance(comparedTo: previousTraitCollection) {
                // Update button colors when the system switches between dark/light modes
                setupButton(captureButton, title: "Capture")
                setupButton(confirmButton, title: "Confirm")
                setupButton(retakeButton, title: "Retake")
            }
    ...
    func showCapturedImage(_ image: UIImage) {
        ...
        imageView.backgroundColor = (colorScheme == .dark ? UIColor.white : UIColor.black)
        ...
        for detection in detections {
            ...
            if let labelText = detection.label {
                ...
                let textFontAttributes = [
                    ...
                    NSAttributedString.Key.foregroundColor: (colorScheme == .dark ? UIColor.black : UIColor.white),
